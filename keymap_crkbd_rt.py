...
# You can either specify rows and cols, or specify pins directly.
# COLS = [board.A2, board.A1, board.A0, board.SCK, board.MISO]
COLS = [board.MISO, board.SCK, board.A0, board.A1, board.A2]
ROWS = [board.D4, board.D5, board.D6, board.D7]
...
# If using rows and cols, uncomment the following line:
PINS = [(r, c) for r in ROWS for c in COLS]
REVERSE_DIODES = True
...
LAYERS = (
    ...
    ('-',     'a',       'r',       't',      's',
     '_os_shft', 'e',    'y',       'i',      'o',
     '_entr', '_os_shft', '_os_ctrl', '_os_alt', '_bksp',
     (3, '_tab'), (2, ' '), (1, '_esc'), '', ''
     ),
